...
/* Scroll */
	if(sf && ($(window).width() > 960)) {
		$('.header__menu-link').on('click', function(e){
			...
			$('html, body').animate({
				scrollTop: h.offset().top - (h.offset().top * 0.2) - 70
			}, 800);
		});
	}
